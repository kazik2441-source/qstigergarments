              ...
              <AnimatePresence>
                {wishlistProducts.map((product) => (
                  ...
                  >
                    ...
                    >
                      <img 
                        src={optimizeCloudinaryUrl((product.images && product.images.length > 0) ? product.images[0] : product.image)} 
                        alt={product.name} 
                        loading="lazy"
                    ...
                    <div className="p-3 sm:p-4 flex flex-col flex-grow text-left cursor-pointer" onClick={() => navigate(`/product/${product.id}`)}>
                      ...
                      {product.originalPrice ? (
                        <div className="flex items-center space-x-2 mt-1 mb-2 shrink-0 select-none">
                          {product.discount ? (
                            <>
